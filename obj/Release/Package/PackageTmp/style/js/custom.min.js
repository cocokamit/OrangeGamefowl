function init_sidebar() {
    if ($(".right_col").height() > $(window).height())
        $(".main_menu").css("height", $(".right_col").height());
...
$MENU_TOGGLE.on("click", function() {
    ...
    if ($BODY.hasClass("nav-md")) {
        $(".mn").css("display", "block").css("padding", "20px 13px");
        $(".mncf").css("border", "0");
        $(".site_tile_a").css("visibility", "visible");
        $("#navtog").css("display", "none");
    }
    else {
        $(".mn").css("display", "none");
        $("#navtog").css("display", "block");
        $(".site_tile_a").css("visibility", "hidden");
        $(".mncf").css("border", "2px solid #fff");
    }
...
CURRENT_URL = window.location.href.replace("%3d", "=");
    $SIDEBAR_MENU.find('a[href="' + CURRENT_URL + '"]').parent("li").addClass("current-page"), $SIDEBAR_MENU.find("a").filter(function() { return this.href == CURRENT_URL }).parent("li").addClass("current-page").parents("ul").slideDown(function() { a() }).parent().addClass("active"), $(window).smartresize(function() { a() }), a(), $.fn.mCustomScrollbar && $(".menu_fixed").mCustomScrollbar({ autoHideScrollbar: !0, theme: "minimal", mouseWheel: { preventDefault: !0} })
